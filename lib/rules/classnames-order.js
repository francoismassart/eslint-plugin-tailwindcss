...
//const loadConfig = require("../util/customConfig");
...
module.exports = {
  ...
  create: function (context) {
    ...
    const configPath = configuration.configPath || "./tailwind.config.js";
    ...
    const userConfig = {
      variants: {
        extend: {
          ...
          translate: ["motion-reduce", "motion-safe"],
          textOpacity: ["motion-safe", "motion-reduce"],
        },
      },
      plugins: [
