            ...
            if (!checkedVariantsValue.includes(key)) {
              ...
              if (sameVariantAndValue.length === 1) {
                ...
                if (hasAll) {
                  ...
                  // const patchedName = `${cls.variants}${all}-${cls.value}`;
                  const patchedName = `${cls.variants}${all}${cls.value.length ? '-' + cls.value : ''}`;
                  ...
                  // const patchedName = `${cls.variants}${xOrYType}-${cls.value}`;
                  const patchedName = `${cls.variants}${xOrYType}${cls.value.length ? '-' + cls.value : ''}`;
                  ...
                  const patchedName = `${cls.variants}${sideBody}${cls.value.length ? '-' + cls.value : ''}`;
                  const toBeReplaced = sameVariantAndValue
                    .filter((c) => {
